    ...
    <div class="sh-main">
           ...
           <div class="nav">
                <ul class="clearfix">
                	...
                	<s:else>
	                    <li><a href="javascript:void(0);" onclick="bind(0)" style="background:#31A4F7">绑定已有账户</a></li>
	                    <s:if test="recruitType ==8"> <!-- 内推注册绑定的入口-->
		                    <li><a href="javascript:void(0);" onclick="bind(2)" class="link_fff">注册并绑定</a></li>
	                    </s:if>
	                    <s:else>
	                    	 <li><a href="javascript:void(0);" onclick="bind(1)" class="link_fff">注册并绑定</a></li>
	                    </s:else>
...
<script type="text/javascript">
	function bind(flg){
		if(flg == 2){
			$("#form1").attr("action","<as:url value='/${corpCode}/web/index/codeToIrRegister'/>");
		}else{
